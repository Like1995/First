...
public class ProviderDaoImpl implements ProviderDao {
	 ...
	 * 根据条件查询总共多少条数据
	 */
	public int getUserCount(Connection connection, String proName,
		...
		if(connection!=null){
			StringBuffer sql=new StringBuffer();
			sql.append("select count(*) from  smbms_provider where id=id");
			if(!StringUtils.isNullOrEmpty(proCode)){
		 		sql.append("  and  procode like ?");
		 		params.add("%"+proCode+"%");
		 	} 
	...
	public List<Provider> getProviderName(Connection connection)
			throws Exception {
		PreparedStatement pstm = null;
		ResultSet rs = null;
		List<Provider> providerList = new ArrayList<Provider>();
